...
CREATE TABLE `places` (
  ...
  `acmpy_type_cd` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '동반유형 (예: 전구역 동반가능 / 일부구역 동반가능)',
  `acmpy_psbl_cpam` varchar(300) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '동반가능동물 설명 (예: 전 견종 가능, 맹견 입마개 필수)',
  `acmpy_need_mtr` varchar(300) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '동반 시 필요사항 (예: 목줄 착용)',
  `rela_poses_fclty` varchar(300) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '반려동물 관련 구비 시설 (예: 배변봉투 비치)',
  `etc_acmpy_info` text COLLATE utf8mb4_unicode_ci COMMENT '기타 동반 정보 (상세 안내 텍스트)',
