...
CREATE TABLE `places` (
  ...
  `sub_category` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '원본 세부 카테고리 (카페/박물관/동물병원 등)',
  `pet_zone_type` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '반려동물 동반 가능 구역 유형 (실내구역/실외구역/전구역)',
  `pet_size_limit` varchar(300) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '입장 가능 반려동물 크기/종류',
  `pet_restrictions` varchar(300) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '반려동물 동반 시 제한사항',
  `has_parking` enum('Y','N') COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '주차 가능 여부 (Y/N)',
  `operation_info` text COLLATE utf8mb4_unicode_ci COMMENT '운영시간 및 휴무일 정보',
