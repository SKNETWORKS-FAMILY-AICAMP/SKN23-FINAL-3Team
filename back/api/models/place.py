...
from sqlalchemy import BigInteger, Boolean, DateTime, Numeric, String, Text, UniqueConstraint, Index, func
...
class Place(Base):
    ...
    rela_poses_fclty: Mapped[str | None] = mapped_column(String(300), nullable=True, comment="반려동물 관련 구비 시설 (예: 배변봉투 비치)")
